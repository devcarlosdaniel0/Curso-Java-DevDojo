...
public class ProducerRepository {
    public static List<Producer> findByName(String name) {
        ...
        try (Connection conn = ConnectionFactory.getConnection();
             PreparedStatement ps = createPreparedStatmentFindByName(conn, name);
    ...
    private static PreparedStatement createPreparedStatmentFindByName(Connection conn, String name) throws SQLException {
    ...
    public static void delete(int id) {
        try (Connection conn = ConnectionFactory.getConnection();
             PreparedStatement ps = createPreparedStatmentDelete(conn, id)) {
            ps.execute();
    ...
    private static PreparedStatement createPreparedStatmentDelete(Connection conn, Integer id) throws SQLException {
